...
- GitHub contains the code and metadata; Hugging Face contains versioned filtered evidence artifacts. The raw FineWeb shard and sentence-segmentation model are not uploaded.
