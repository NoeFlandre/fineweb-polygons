...
- V1, V2, V3, V4, V5, and V6 runs record immutable input references, the complete selected version definition, configuration fingerprints, chunk checkpoints, structured logs, and output manifests. V5 and V6 also record their reusable name-frequency artifacts.
