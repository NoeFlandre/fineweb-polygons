...
The current V1, V2, and V3 releases add narrow, resumable exact-match baselines over one FineWeb 10BT Parquet shard and Monaco polygon profiles. Their immutable contracts are documented in the [version guide](versions.md).
...
- V1, V2, and V3 runs record immutable input references, the complete selected version definition, configuration fingerprints, chunk checkpoints, structured logs, and output manifests.
