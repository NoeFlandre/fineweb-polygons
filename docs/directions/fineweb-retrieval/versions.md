...
FineWeb `text` field against the approved [V8 topic vocabulary](https://huggingface.co/datasets/NoeFlandre/fineweb-polygons/blob/main/metadata/direction-1-retrieval/v8/topic-vocabulary-v1.json).
...
implementation is in [`v8.py`](https://github.com/NoeFlandre/fineweb-polygons/blob/main/src/fineweb_polygons/directions/retrieval/stages/v8.py).
...
[`direction-2-lexical-v1`](../lexical-candidates/README.md) and
[`direction-2-lexical-v2`](../lexical-candidates/v2/README.md).
