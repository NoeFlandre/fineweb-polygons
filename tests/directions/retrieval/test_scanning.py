...
import fineweb_polygons.core.artifact_io as artifact_io
import fineweb_polygons.directions.retrieval.scanning as scanning_module
...
from fineweb_polygons.directions.retrieval.scanning import (
    ScanStats,
    _as_text,
    _projected_columns,
    _row_start,
