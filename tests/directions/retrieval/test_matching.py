...
from fineweb_polygons.directions.retrieval.matching import (
    EvidenceMatcher,
    _closest_span_pair,
    _context_candidates,
    _excerpt,
...
from fineweb_polygons.directions.retrieval.models import FineWebDocument, PolygonProfile
...
def test_matcher_normalizes_the_default_context_name_without_url_decoding(
    ...
    monkeypatch.setattr(
        "fineweb_polygons.directions.retrieval.matching.normalize_for_search",
        fake_normalize,
    )
...
def test_v2_passes_the_configured_context_to_its_context_helper(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "fineweb_polygons.directions.retrieval.matching._find_context",
        fake_find_context,
    )
...
def test_context_helpers_pass_their_canonical_default_to_nested_calls(
    ...
    monkeypatch.setattr(
        "fineweb_polygons.directions.retrieval.matching._context_candidates",
        fake_candidates,
    )
    ...
    monkeypatch.setattr(
        "fineweb_polygons.directions.retrieval.matching.has_context_marker", fake_marker
    )
