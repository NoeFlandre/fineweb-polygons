...
_SCHEMA_VERSION = 2
_MATCHER_VERSIONS = {
    "v1": "v1-exact-name-context",
    "v2": "v2-exact-name-url-or-text-with-text-country-context",
}
_PROFILE_VERSIONS = {
    "v1": "v1-all-named-closed-ways-and-polygon-relations",
    "v2": "v2-in-boundary-meaningful-names",
}
...
class ScanRunConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if self.retrieval_version not in _MATCHER_VERSIONS:
            raise ValueError("retrieval_version must be v1 or v2")
...
def execute_run(
    ...
    *,
    ...
    configuration = {
        ...
        "matcher_version": _MATCHER_VERSIONS[config.retrieval_version],
        "normalization_version": NORMALIZATION_VERSION,
        "polygon_profile_version": _PROFILE_VERSIONS[config.retrieval_version],
        "retrieval_version": config.retrieval_version,
    }
    ...
    matcher = EvidenceMatcher(
        selected_profiles,
        require_text_context=config.retrieval_version == "v2",
    )
